...
ZSF.TEAM_ZOMBIE = 3
ZSF.TEAM_UNDEAD = ZSF.TEAM_ZOMBIE
ZSF.TEAM_SURVIVORS = 4
ZSF.TEAM_HUMAN = ZSF.TEAM_SURVIVORS

team.SetUp(ZSF.TEAM_ZOMBIE, "The Undead", Color(0, 255, 0))
team.SetUp(ZSF.TEAM_SURVIVORS, "Survivors", Color(0, 160, 255))
...
function GetZombieFocus(mypos, range, multiplier, maxper)
	...
	for _, ply in ipairs(player.GetHumans()) do
		if ply:Team() == ZSF.TEAM_UNDEAD and ply:Alive() then
