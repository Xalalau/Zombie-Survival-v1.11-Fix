...
SWEP.ViewModel = "models/weapons/v_keyboard/v_keyboard.mdl"
...
function SWEP:Precache()
	util.PrecacheSound("weapons/melee/keyboard/keyboard_hit-01.wav")
	util.PrecacheSound("weapons/melee/keyboard/keyboard_hit-02.wav")
	util.PrecacheSound("weapons/melee/keyboard/keyboard_hit-03.wav")
	util.PrecacheSound("weapons/melee/keyboard/keyboard_hit-04.wav")
end
...
local function StabCallback(attacker, trace, dmginfo)
	if trace.Hit and trace.HitPos:Distance(trace.StartPos) <= 70 then
		...
		if SERVER then
			attacker:EmitSound("weapons/melee/keyboard/keyboard_hit-0"..math.random(1,4)..".wav")
		end
